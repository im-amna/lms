    ...
    if (action === "add") {
      ...
      if (title) {
        const newChapter = {
          ...
          chapterContent: [],
          collapsed: false,
          // ✅ Fix: NaN na aaye isliye simple length use karo
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col gap-6 mt-4">
          ...
          <div className="flex md:flex-row flex-col items-center gap-3">
            ...
            <label htmlFor="thumbnailImage" className="flex items-center gap-3 cursor-pointer">
              ...
              />
              {image && (
                <img src={URL.createObjectURL(image)} alt="Thumbnail Preview" className="max-h-10 rounded" />
              )}
            </label>
          </div>
        </div>
        ...
        <div className="mt-6">
          {chapters.map((chapter, chapterIndex) => (
            // ✅ Fix: chapterId use karo — NaN key warning khatam
              ...
              {!chapter.collapsed && (
                <div className="p-4">
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    // ✅ Fix: lectureId use karo — NaN key warning khatam
